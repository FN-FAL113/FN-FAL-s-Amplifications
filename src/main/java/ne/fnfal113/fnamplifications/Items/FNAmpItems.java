...
public class FNAmpItems {
    ...
    public static final SlimefunItemStack FN_GEM_RETALIATE = new SlimefunItemStack(
            ...
            "&cRetaliate Gem",
            "",
            "&eAllows your weapons to return back to you after throwing",
            "&eand hitting an object or entity, weapon must have any",
            "&eof these gems bound to it before binding this gem:",
            "&e- Damnation Gem",
            "&e- Tri-Sword Gem",
            "&e- Axe Throwie Gem",
            "",
    ...
    public static final SlimefunItemStack FN_GEM_GUARDIAN = new SlimefunItemStack(
            ...
            "&cGuardian Gem",
            "",
            "&e" + value.guardianGem() +"&e% chance to spawn a",
            "&eguardian that will fight for you until death, the",
            "&earmor that has this gem must be worn in order for",

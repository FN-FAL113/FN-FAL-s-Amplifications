...
public class ArrowAvertGem extends AbstractGem implements OnArrowHitHandler {
    ...
    public void onArrowHit(ProjectileHitEvent event, Player player, LivingEntity entity) {
        ...
        if(ThreadLocalRandom.current().nextInt(100) < getChance()){
            ...
            playerVictim.sendMessage(Utils.colorTranslator("&6Enemy arrow deflected! arrow avert gem has taken effect."));
            player.sendMessage(Utils.colorTranslator("&cYour arrow was deflected by your enemy!"));
        }
    }
}
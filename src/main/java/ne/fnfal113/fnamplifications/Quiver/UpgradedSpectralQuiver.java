...
public class UpgradedSpectralQuiver extends SlimefunItem implements QuiverImpl {
    ...
    public UpgradedSpectralQuiver(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe, int quiverSize, ItemStack arrowType) {
        ...
        this.defaultUsageKey3 = new NamespacedKey(FNAmplifications.getInstance(), "upgradedspectral_state");
